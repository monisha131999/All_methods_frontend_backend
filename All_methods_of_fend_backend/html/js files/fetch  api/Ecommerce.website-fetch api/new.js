...
function addElement(appendIn, value){
    ...
    let { image, title, description, category, price} = value;
    ...
    div.innerHTML = `
            ...
            <div class="text-center py-3 font-poppins">
                ...
                <button class="border-2 px-8 py-1 bg-yellow-400 border rounded-md"onclick='addtocart("+(i++)+")'>Add to cart</button>
